  ...
  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 p-1" key={card.id}>
    <div className="nft_coll">
      ...
      <div className="nft_coll">
        <div className="nft_wrap">
          <Link to="/item-details">
            <img src={'https://gratisography.com/wp-content/uploads/2024/10/gratisography-cool-cat-800x525.jpg'} className="lazy img-fluid" alt="" />
          </Link>
        </div>
        <div className="nft_coll_pp">
          <Link to="/author">
            <img className="lazy pp-coll" src={'https://gratisography.com/wp-content/uploads/2024/10/gratisography-cool-cat-800x525.jpg'} alt="" />
          </Link>
          <i className="fa fa-check"></i>
        </div>
        <div className="nft_coll_info">
          <Link to="/explore">
            <h4>Jessica Alpine</h4>
          </Link>
          <span>ERC-47282</span>
        </div>
      </div>
