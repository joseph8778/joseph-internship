...
return { secTxt, minTxt, hrs };

};

// Set up the countdown timer only for items that are being displayed
...
// Update only the time left for each item
...
{timeLeft.hrs}h {timeLeft.minTxt}m {timeLeft.secTxt}s
